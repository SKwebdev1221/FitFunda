    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Schedule a visit with one of our healthcare professionals</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b">
              <div>
                ...
                <p className="text-sm text-gray-500">January 25, 2024 at 10:00 AM</p>
              </div>
