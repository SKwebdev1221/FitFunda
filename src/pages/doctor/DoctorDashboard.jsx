      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-3xl font-bold text-blue-600">{stats?.todays_patients || 0}</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-3xl font-bold text-green-600">{stats?.completed_consultations || 0}</p>
            <p className="text-sm text-gray-500">This week</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-gray-900">Avg. Consultation Time</h3>
            <p className="text-3xl font-bold text-purple-600">{stats?.avg_consultation_time || '0m'}</p>
