  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="c h-font text-3xl font-bold text-gray-900">Patient Queue</h1>
          <p className="w c mt-2 text-gray-600">Manage your patient waiting list and consultations</p>
        </div>
