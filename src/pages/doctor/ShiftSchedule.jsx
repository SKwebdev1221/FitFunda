  ...
  const currentWeek = [
    {
      ...
      date: 'Jan 15',
      shifts: [
        { time: '8:00 AM - 4:00 PM', type: 'Regular', location: 'Main Hospital' },
        { time: '4:00 PM - 12:00 AM', type: 'On Call', location: 'Emergency' }
      ]
    },
    {
      day: 'Tuesday',
    ...
    },
    {
      ...
      date: 'Jan 17',
      shifts: [
        { time: '12:00 PM - 8:00 PM', type: 'Regular', location: 'Clinic' }
      ]
    },
    {
      day: 'Thursday',
    ...
    },
    {
      ...
      shifts: [
        { time: '8:00 AM - 4:00 PM', type: 'Regular', location: 'Main Hospital' },
        { time: '6:00 PM - 6:00 AM', type: 'Emergency', location: 'ER' }
      ]
    },
    {
      day: 'Saturday',
        ...
        <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 mb-8 rounded-lg">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-red-800 mb-2">High Surge Alert: Pulmonology Patients</h3>
              <p className="text-red-700 mb-3">
                Diwali pollution surge expected to increase respiratory cases by 40% in the next 24 hours.
                Your specialty (Pulmonology) is particularly affected with predicted 65+ additional patients.
              </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Main Hospital - General Medicine</p>
                </div>
                <div className="text-right">
                  <p className="font-medium text-gray-900">8:00 AM - 4:00 PM</p>
              ...
              <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                <div>
                  <h3 className="font-medium text-gray-900">On Call</h3>
                  <p className="text-sm text-gray-600">Emergency Department</p>
                </div>
                <div className="text-right">
                  <p className="font-medium text-gray-900">4:00 PM - 12:00 AM</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">18 shifts</span>
              </div>

              <div className="flex justify-between items-center">
                <span className="text-gray-600">On Call Shifts</span>
                <span className="font-medium">8 shifts</span>
              </div>

              <div className="flex justify-between items-center">
                <span className="text-gray-600">Emergency Coverage</span>
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <p className="text-xs text-gray-500 mt-1">105% of target completed</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <textarea
                ...
                defaultValue="Available for emergency coverage. Prefer no more than 3 consecutive night shifts."
              ></textarea>
            </div>
          </div>
