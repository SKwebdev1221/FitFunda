  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 py-12">
        <div className="mb-8">
          <h1 className="c h-font text-3xl font-bold text-gray-900">Inventory Reports</h1>
          <p className="w c mt-2 text-gray-600">Comprehensive reports on inventory status, usage, and performance</p>
        </div>
